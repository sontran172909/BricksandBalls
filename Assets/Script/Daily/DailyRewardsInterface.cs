...
namespace NiobiumStudios
{
    ...
    public class DailyRewardsInterface : MonoBehaviour
    {
        ...
        public void buttononclickpannel()
        {
        ...
        public void UpdateUI()
        {
            ...
            switch (lastReward)
            {
                ...
                case 1:
                    PlayerPrefs.SetInt("idballselected", 2);
                    // Debug.Log("VAR1");
                    break;
                case 2:
                    PlayerPrefs.SetInt("+3", PlayerPrefs.GetInt("+3") + 5);
                    //Debug.Log("VAR2");
                    break;
                case 3:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    PlayerPrefs.SetInt("X3", PlayerPrefs.GetInt("X3") + 5);
                    break;
                case 6:
